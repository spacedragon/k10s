...
- [ ] Write failing tests for P0/P1/P2 ordering, same-resource P2 coalescing, non-droppable terminal operation events, snapshot chunk limits, control/log/exec frame limits, full client inbox, subscription/session limits, and slow-client close reason.
